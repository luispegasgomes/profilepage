  ...
  state: {
    ...
    projects: [
      ...
      },
      {
        ...
        subtitle: "CG | Group 10 | TSIW 2nd Year",
    ...
    academics: [
      ...
      },
      {
        ...
        title: "Escola Superior de Media Artes e Design",
        average: "15,4",
        skills: [
          { text: 'HTML-E34F36', name: 'html5', color: 'FFFFFF' },
          { text: 'CSS-1572B6', name: 'css3', color: 'FFFFFF' },
          { text: 'JS-F7DF1E', name: 'javascript', color: '000000' },
          { text: 'Native-d9d9d9', name: 'react', color: '000000' },
          { text: 'React-586F7C', name: 'react', color: 'FFFFFF' },
          { text: 'vue-35495E', name: 'vue.js', color: '4FC08D' },
          { text: 'Node-d9d9d9', name: 'Node.js', color: '000000' },
          { text: 'python-14354C', name: 'python', color: 'FFFFFF' },
          { text: 'SQL-0675B4', name: 'mysql', color: 'FFFFFF' },
          { text: 'MONGO-4EA94B', name: 'mongodb', color: 'FFFFFF' },
          { text: 'GQL-E535AB', name: 'graphql', color: 'FFFFFF' },
    ...
    professional: [
      ...
      },
      {
        ...
        video: "https://www.youtube.com/watch?v=opE_ThSVI2g&ab_channel=EscolaSuperiordeMediaArteseDesign",
        skills: [
          { text: 'React-586F7C', name: 'react', color: 'FFFFFF' },
          { text: 'Redux-593D88', name: 'redux', color: 'FFFFFF' },
          { text: 'Ractive-00C1CE', name: 'javascript', color: 'white' }, 
